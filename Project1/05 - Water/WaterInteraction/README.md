<div align="center">
    ...
    <p>
      <picture>
          <source srcset="media/waterdrops2.webp" type="image/webp">
          <img src="media/waterdrops2.gif" alt="Preview" title="Preview" height=500>
      </picture> 
      <picture>
          <source srcset="media/wavesimulation.webp" type="image/webp">
          <img src="media/wavesimulation.gif" alt="Preview" title="Preview" height=500>
      </picture>
    </p>
</div>
...
<p>
  <picture>
    <source srcset="media/waterdrops_texture.webp" type="image/webp">
    <img src="media/waterdrops_texture.gif" alt="Water Droplets Using Textures" title="Water Droplets Using Textures" width=500>
  </picture> 
  <img src="media/waterdrops_texture_nodes1.png" alt="Nodes of Water Droplets Using Textures" title="Nodes of Water Droplets Using Textures" width=500> <img src="media/waterdrops_texture_nodes2.png" alt="Nodes of Water Droplets Using Textures" title="Nodes of Water Droplets Using Textures" width=500> <img src="media/waterdrops_texture_nodes3.png" alt="Nodes of Water Droplets Using Textures" title="Nodes of Water Droplets Using Textures" width=500>
</p>
...
<p>
  <picture>
    <source srcset="media/caustics.webp" type="image/webp">
    <img src="media/caustics.gif" alt="Caustics" title="Caustics" width=500>
  </picture> 
  <img src="media/caustics_params.png" alt="Caustics Parameters" title="Caustics Parameters" width=350> <br> <img src="media/caustics_nodes.png" alt="Caustics Nodes" title="Caustics Nodes" width=1000> <br> <img src="media/caustics_code1.png" alt="Caustics Code" title="Caustics Code" width=300> <img src="media/caustics_code2.png" alt="Caustics Code" title="Caustics Code" width=350>
</p>
...
<p>
  <img src="media/foam2.png" alt="Foam" title="Foam" width=500> 
  <picture>
    <source srcset="media/foam.webp" type="image/webp">
    <img src="media/foam.gif" alt="Foam" title="Foam" width=500>
  </picture> <br> 
  <img src="media/foam_nodes.png" alt="Foam Nodes" title="Foam Nodes" width=600> <img src="media/foam_params.png" alt="Foam Parameters" title="Foam Parameters" width=350>
</p>
...
<p>
  <picture>
    <source srcset="media/waterdrops2.webp" type="image/webp">
    <img src="media/waterdrops2.gif" alt="Waterdrops" title="Waterdrops" width=500>
  </picture> <br> 
  <img src="media/waterdrops_code1.png" alt="Waterdrops Code" title="Waterdrops Code" width=400> <img src="media/waterdrops_code2.png" alt="Waterdrops Code" title="Waterdrops Code" width=600>
</p>
